...
const ExperienceSection = () => {
  const workExperience = {
    ...
    specificWork: [
      ...
      "💰 Monetization & Tracking SDK: Built and maintained a centralized, reusable Android SDK unifying AdMob, AppLovin MAX, Adjust, and AppsFlyer, acting as the core monetization engine for 30+ products.",
      "📈 Revenue & ROAS Optimization: Engineered advanced ad-loading strategies (caching, pre-fetching, bidding) and precise event postback pipelines to maximize ARPDAU and ensure accurate user acquisition (UA) tracking.",
      "🎮 Engine Bridging & Compliance: Developed low-latency Unity Bridge layers (JNI) for seamless callback handling, while strictly managing user consent flows (UMP/GDPR) and maintaining memory safety.",
